...
# List all files in '/var/backup', including files sizes, and save the output to 'var/backup/file_report.txt
ls -lh /var/backup > /var/backup/file_report.txt

# Print how much free memory your machine has left. Save this to a files called '/var/backup/disk_report.txt'
